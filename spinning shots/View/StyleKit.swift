...
//  SpinningShots
//
//  Created by Marc Zobec on 2015-11-09.
...
public class StyleKit : NSObject {
    ...
    public class func drawBorder(borderStrokeColor borderStrokeColor: UIColor = UIColor(red: 0.502, green: 0.502, blue: 0.502, alpha: 1.000), borderDiameter: CGFloat = 100, borderStrokeWidth: CGFloat = 2, isBorderFullCircle: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()


        //// Variable Declarations
        let borderPathWidth: CGFloat = borderDiameter - borderStrokeWidth
        let expression: CGFloat = borderStrokeWidth / 2.0
        let borderRectMaskHeight: CGFloat = isBorderFullCircle ? borderDiameter : borderDiameter / 2.0
        ...
        //// Clip Rectangle
        let rectanglePath = UIBezierPath(rect: CGRectMake(0, 0, borderDiameter, borderRectMaskHeight))
        rectanglePath.addClip()


        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalInRect: CGRectMake(expression, expression, borderPathWidth, borderPathWidth))
        borderStrokeColor.setStroke()
        ovalPath.lineWidth = borderStrokeWidth
        ovalPath.stroke()
    ...
    public class func drawCircleMask(frame frame: CGRect = CGRectMake(0, 0, 100, 100)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.moveToPoint(CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 0.50000 * frame.height))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 0.50000 * frame.width, frame.minY + 1.00000 * frame.height), controlPoint1: CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 0.77614 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.77614 * frame.width, frame.minY + 1.00000 * frame.height))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 0.00000 * frame.width, frame.minY + 0.50000 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.22386 * frame.width, frame.minY + 1.00000 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.00000 * frame.width, frame.minY + 0.77614 * frame.height))
        bezierPath.addLineToPoint(CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 0.50000 * frame.height))
        bezierPath.closePath()
    ...
    public class func drawGameCenterButton(buttonFillColor buttonFillColor: UIColor = UIColor(red: 0.788, green: 0.839, blue: 0.875, alpha: 1.000), buttonStrokeColor: UIColor = UIColor(red: 0.322, green: 0.380, blue: 0.420, alpha: 1.000), buttonFrameDiameter: CGFloat = 100) {
        ...
        //// Subframes
        let group3: CGRect = CGRectMake(frame.minX + floor(frame.width * 0.21115 + 0.38) + 0.12, frame.minY + floor(frame.height * 0.15787 - 0.29) + 0.79, floor(frame.width * 0.78885 - 0.38) - floor(frame.width * 0.21115 + 0.38) + 0.77, floor(frame.height * 0.84213 + 0.29) - floor(frame.height * 0.15787 - 0.29) - 0.57)
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(rect: CGRectMake(group3.minX + floor(group3.width * -0.06907 + 0.49) + 0.01, group3.minY + floor(group3.height * -0.07325 - 0.49) + 0.99, floor(group3.width * 1.06907 - 0.26) - floor(group3.width * -0.06907 + 0.49) + 0.75, floor(group3.height * 1.07325 + 0.06) - floor(group3.height * -0.07325 - 0.49) - 0.55))
        buttonStrokeColor.setFill()
        rectanglePath.fill()
